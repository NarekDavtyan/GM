...
public class VkAdvertisment {
	...
	public VkAdvertisment(int vkId, int advertismentId, int showCount, Calendar lastGivenDate, Calendar lastUpdate, int version)
	{
		this.vkId = vkId;
	...
	public VkAdvertisment(int vkId, int advertismentId, int showCount, Calendar lastUpdate, int version)
	{
		this.vkId = vkId;
		this.advertismentId = advertismentId;
		this.showCount = showCount;
